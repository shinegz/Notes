...
<description>Autonomous learning agent that studies materials on behalf of the user. Use when user wants to learn a new topic, understand complex materials, or needs a comprehensive summary of learning resources. Trigger when user says things like "help me learn", "study this for me", "summarize these materials", "I want to understand X", "research this topic", or provides multiple learning resources asking for synthesis. This skill reads provided materials, identifies knowledge gaps, searches for supplementary information, and produces a well-structured learning summary document.</description>
<location>project</location>
</skill>
