...
![browser high level structure](.\浏览器工作原理\browser high level structure.png)
...
![render basic flow](.\浏览器工作原理\render basic flow.png)
...
![webkitflow](.\浏览器工作原理\webkitflow.png)

​                                                           **Figure : WebKit main flow**

![Gecko flow](.\浏览器工作原理\Gecko flow.jpg)
