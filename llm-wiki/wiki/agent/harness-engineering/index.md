# harness-engineering（子主题）

本目录与 `raw/agent/harness-engineering/` 对齐，用于 Harness Engineering 相关来源与概念页。

## 概念

- [[agent/harness-engineering/concepts/HarnessEngineering|Harness Engineering]]

## 来源（2026-04-14 ingest）

- [[agent/harness-engineering/sources/深度解析-Harness-Engineering|深度解析（公众号）]] — 综合解读
...
- [[agent/harness-engineering/syntheses/harness-engineering-deep-dive|Harness Engineering 深度解析]]（交叉综合 11 篇来源）

## 布局

- `sources/` — 每篇已落盘素材对应一页
- `entities/` / `concepts/` / `syntheses/` — 随 ingest 扩充
