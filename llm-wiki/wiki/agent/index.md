...
编码智能体、Harness、工具链与仓库内知识治理。

## 子主题

- [[agent/harness-engineering/index|harness-engineering]] — Harness Engineering 素材与编译页
...
- [[agent/harness-engineering/sources/openai-harness-engineering-zh|OpenAI 中文 Harness 文]]
...
- [[agent/harness-engineering/sources/anthropic-effective-harnesses-long-running-agents|Anthropic — Long-running agents]]
...
- [[agent/harness-engineering/sources/mitchellh-ai-adoption-journey-step-5-harness|Mitchell Hashimoto — Step 5]]
...
- [[agent/harness-engineering/syntheses/harness-engineering-deep-dive|Harness Engineering 深度解析]]
