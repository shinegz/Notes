...
- **AI Fundamentals**：AI 理论基础知识库，涵盖 Transformer 架构、预训练、Scaling Laws、RLHF、LLM Agent 等核心概念。2026-04-19 完成初始化：6 个主题 source 摘要 + 5 篇概念页。2026-04-23 新增综合文 [[ai-fundamentals/syntheses/ai-core-concepts|AI核心概念体系]]。2026-04-23 **re-ingest**：新增 18 个 source 摘要（3 articles + 2 refs + 13 PDFs），覆盖 Agent 系统、Transformer 可视化与 taxonomy、Alignment（RLHF/DPO）、效率优化（LoRA/GQA/RoPE）、Scaling Laws（Chinchilla）、经典工作（AlexNet/ResNet/word2vec/GAN）及历史趋势。见子主题 [[ai-fundamentals/index|ai-fundamentals]]、总览 [[ai-fundamentals/overview|ai-fundamentals overview]]。
