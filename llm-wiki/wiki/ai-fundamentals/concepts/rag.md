...
[[ai-fundamentals/sources/llm-powered-autonomous-agents|LLM Powered Autonomous Agents]] 指出 LLM 的两大固有限制：
...
- [[ai-fundamentals/sources/llm-powered-autonomous-agents|LLM Powered Autonomous Agents]] — Agent 长期记忆与检索机制
