...
[[ai-fundamentals/sources/llm-powered-autonomous-agents|LLM Powered Autonomous Agents]] 明确指出 LLM 的两大限制：
...
[[ai-fundamentals/sources/llm-powered-autonomous-agents|LLM Powered Autonomous Agents]] 将这一检索过程称为 MIPS（Maximum Inner Product Search）。
...
- [[ai-fundamentals/sources/llm-powered-autonomous-agents|LLM Powered Autonomous Agents]] — Agent 长期记忆与 MIPS 检索
- [[ai-fundamentals/sources/word2vec|word2vec]] — Embedding 向量表示的基础
