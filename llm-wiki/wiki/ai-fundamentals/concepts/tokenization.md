...
**Tokenization = 将原始文本切分为模型可处理的 token 序列。**
...
[GPT-3](../sources/gpt3-language-models-few-shot.md) 使用 BPE tokenizer，vocab size 为 50,257。
...
[The Illustrated Transformer](../sources/the-illustrated-transformer.md) 描述的流程：
...
- [The Illustrated Transformer](../sources/the-illustrated-transformer.md) — Transformer 输入流程可视化
- [GPT-3](../sources/gpt3-language-models-few-shot.md) — BPE tokenizer, vocab size 50,257
