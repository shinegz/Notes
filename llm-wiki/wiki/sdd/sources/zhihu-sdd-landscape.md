...
- [[sdd/entities/Spec-Kit|Spec-Kit]] — GitHub 官方工具包
- [[sdd/entities/OpenSpec|OpenSpec]] — Brownfield-First 轻量框架
- [[sdd/entities/Superpowers|Superpowers]] — TDD + Skills 框架
- [[sdd/entities/Kiro|Kiro]] — AWS IDE 集成方案
- [[sdd/entities/Tessl|Tessl]] — Spec-as-Source 实验平台
